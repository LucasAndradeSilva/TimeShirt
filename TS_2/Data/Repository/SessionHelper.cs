...
namespace TS_2 {
    public static class SessionHelper {
        ...
        //=== GET USUARIO ====
        //====================
        public static mdDadosUserLogado GetUsuario(this ISession session) => session.Get<mdDadosUserLogado>() == null ? session.Get<mdDadosUserLogado>(SessionKeys.Usuario) : session.Get<mdDadosUserLogado>();
        public static bool isLogado(this ISession session) {
            if (session.TryGetValue(typeof(mdDadosUserLogado).FullName, out byte[] bytesUsr))
